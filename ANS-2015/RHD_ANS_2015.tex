...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Regularization of the non-equilibrium Grey Radiation Hydrodynamic Equations}
\author{Marc O. Delchini$^{*}$, Jean C. Ragusa$^{*}$}

\institute{
$^{*}$Department of Nuclear Engineering, Texas A\&M University}

\email{delchmo@tamu.edu \and jean.ragusa@.tamu.edu}
...
Edwards et al. \cite{EdwardsMorelLowrie} employed a two-stage semi-implicit IMEX scheme to solve the Radiation-Hydrodynamic equations. 
...
by the derivation of the entropy residual equation. We provide below the main steps leading to that equation and given in \cite{our_jcp_radhy_paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
In this paper, we have demonstrated that the viscous regularization, previously derived
...
This regularization has intrinsic mathematical properties of interest for the development of numerical schemes
