...
compared with semi-analytical reference solutions by performing a convergence study. \tcb{The method employed to perform the convergence study with a semi-analytical solution is detailed, and results show that the correct convergence rates are achieved for all tests.}
\end{abstract}
%-------------------------
...
The new theoretical result is illustrated in \sct{sec:num-rslt} with numerical results for Mach 1.05 and Mach 3 tests. For each test, the numerical solution is compared against semi-analytical solutions by performing a convergence study. \tcb{The method employed to perform the convergence study is detailed in \sct{sec:mthd-conv-test} as it uses a semi-analytical solution that is invariant under spatial shifts \cite{LowrieEdwards}.} We recall that, in the remaining of this paper, the opacity is denoted by $\sigma$ and has of units $cm^{-1}$. 
...
The authors would like to acknowledge Robert Lowrie and Jim Morel for many fruitful discussions.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
