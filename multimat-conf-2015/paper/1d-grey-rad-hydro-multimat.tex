...
The GRH equations form a non-conservative multi-physics system of equations that couples the inviscid hydrodynamic equations, i.e., Euler equations, with a parabolic radiation-diffusion equation. \tcb{A non-exhaustive list of domain of applications includes astrophysics, inertial confinement fusion (ICF) and flows with high temperatures (REFs).}
...
conservation laws \cite{Lax}. \tcb{This approach, however, does not always ensure convergence of the numerical solution to the entropy solution as shown in \cite{abgrall-karni-2010}.}
...
\end{eqnarray}
%
where $left$ and $right$ correspond to the pre- and post-shock states, respectively. Note that $\epsilon$ remains smooth across jump whereas the material properties $\rho$, $u$, $P$ and $T$ may be discontinuous.}
%------------------------------------------------------------------
