...
\tcb{Numerical results and convergence studies are presented in \sct{sec:num-rslt}. We first detail the procedure used for the convergence studies. Then, numerical results for Mach 1.05 and Mach 3 tests are presented.
