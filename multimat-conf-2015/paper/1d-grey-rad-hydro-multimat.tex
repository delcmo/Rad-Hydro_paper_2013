...
\tcb{add regularized equilibrium-diffusion equations}
%
...
%%
%------------------------------------------------------------------
\subsection{Definition of the artificial entropy viscosity coefficient $\kappa$.}
\label{sec:visc-coeff-def}
%------------------------------------------------------------------
%
...
%------------------------------------------------------------------
%
In the previous Section, we briefly reviewed the viscous regularization for the GRH 
...
yield positive terms when using the functional form of the entropy function given in \eqt{eq:ent_equ}. It is also shown that the entropy equation recalled in \eqt{eq:app_entr_eq_non_equil} devolves to
its counterpart when considering the equilibrium diffusion limit. \tcb{To reformulate}
%
%------------------------------------------------------------------
...
%------------------------------------------------------------------
%
In \cite{our_jcp_radhy_paper}, the viscous regularization for the GRH equations is shown to yield well scaled viscous terms in the equilibrium-diffusion limit \tcb{add section}. It is proposed in this section, to show that the
entropy equation derived for the regularized GRH, \eqts{eq:regularized_hyperbolic_GRH}, devolves to the entropy equation that would be obtained from the equilibrium-diffusion equations. Such behavior is expected but proof of it was not provided in \cite{our_jcp_radhy_paper}.
