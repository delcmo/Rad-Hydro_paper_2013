...
%------------------------------------------------------------------
%
\tcb{we should probably remove this section and simply reference the first paper. The definition has not changed. Everything else in the section is of interest for the following section and shoul dbe kept. Give the equation number and page} \\
...
\tcb{add two figures of the density before and after the shift}
%
\begin{figure}[H]
