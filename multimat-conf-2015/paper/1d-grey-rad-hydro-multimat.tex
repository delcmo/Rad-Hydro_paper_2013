...
yield positive terms when using the functional form of the entropy function given in \eqt{eq:ent_equ}. Since we have 
already established that the dissipative terms yield the positive terms shown on the right-hand side of 
\eqt{eq:app_entr_eq_non_equil}, we omit them for brevity in the derivation below as their contribution to the entropy residual 
