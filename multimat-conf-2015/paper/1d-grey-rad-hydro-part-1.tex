...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../figures/cst-xs/mach-3-dens-1000-cells.png}
    \caption{Steady-state solution of the material density for the Mach 3 shock test.}\label{fig:mach-3-cst-xs-dens}
\end{figure}
%
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../figures/cst-xs/mach-3-temp-1000-cells.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../figures/cst-xs/mach-3-visc-1000-cells.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../figures/dpt-xs/mach-3-temp-dpt-xs-density-1000.png}
    \caption{Steady-state solution of the material density for the Mach 3 shock test.}\label{fig:mach-3-dpt-xs-dens}
\end{figure}
%
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../figures/dpt-xs/mach-3-temp-dpt-xs-temperature-1000.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../figures/dpt-xs/mach-3-temp-dpt-xs-viscosity-1000.png}
