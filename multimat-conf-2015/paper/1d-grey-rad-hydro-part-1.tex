...
\end{equation}
%
with $x=  \left(\frac{aT^4}{\epsilon}\right)^\frac{1}{4} \geq 0$ and remembering that the speed of light, $c$ and the absorption cross section, $\sigma_a$ are positive by definition. \tcb{What about $\epsilon$?}.
