...
radiation-diffusion equation. The coupling between the two physics is ensured through relaxation terms (REF) \tcb{I will add this ref}
...
equations (REF). The EDL can be obtained from the GRH by performing a Chapman-Enskog expansion (REF) \tcb{I will add this ref}.
...
3 are given in \sct{sec:num-rslt} and compared against semi-analytical solutions obtained from REF \tcb{I think we should use Jim's dissertation for the reference. I emailed him for a more specific paper}. Test cases with 
...
For the radiation diffusion equation, vacuum boundary conditions are used at both inlet and outlet. For each numerical results presented in \sct{sec:mach-3-cst-xs} and \sct{sec:mach-3-no-cst-xs}, the initial conditions and other relevant information will be specified.
%
%------------------------------------------------------------------
\subsection{Mach 3 shock test with constant opacities}\label{sec:mach-3-cst-xs}
%------------------------------------------------------------------
%
\tcb{I will add this tomorrow}
%\begin{table}[H]
