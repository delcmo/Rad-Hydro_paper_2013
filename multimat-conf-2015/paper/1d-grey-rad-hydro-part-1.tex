...
%------------------------------------------------------------------
%
In this section, we recall the main results obtained in \cite{our_jcp_radhy_paper}. These will serve as the foundation for the 
applying the viscous regularization to the full non-equilibrium grey Radiation-Hydrodynamic equations  (GRH) equations, 
later derived in in \sct{sec:VR_new}. 
%

First, the 1-D  non-equilibrium grey Radiation-Hydrodynamic equations \emph{without} viscous regularization are given in \eqt{eq:GRH}. 
Then, the reader is guided through the main steps that were detailed in \cite{our_jcp_radhy_paper} to derive the viscous regularization using an entropy condition. At last, the 1-D non-equilibrium grey Radiation-Hydrodynamic equation \emph{with} viscous regularization are recalled.
