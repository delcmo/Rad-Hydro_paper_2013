...
\small{First email, 3/31. Maybe not small enough time step. Legend is wrong (ref. slope is 2)}
...
\setcounter{subfigure}{0}% Reset subfigure counter
\small{First email, March 31. Maybe not small enough time step. }
