...
We added a reference in Section 2.1 at lines 113-114 for the shock conditions associated to the GRH. The same jump relations of the un-regularized GRH, i.e. without artificial viscous fluxes, are recalled for a steady shock below(see also Eq. 12 of \cite{LowrieEdwards}):
%
