...
We moderated the introduction by saying that the DLM theory can be applied but does not guarantee convergence of the numerical solution to the weak solution. We also included the reference you provided for completeness. 
\bigskip
...
\item the radiation flux is time-independent diffusive (F = - $\grad$ E, and if in the lab-frame then add the radiation enthalpy, 4 ar u $T^4 / 3$)
