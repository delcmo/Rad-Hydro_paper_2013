...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
i=0;
% i=i+1; numeric_filename{i}='mach-3-fo-nel-100-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-200-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-300-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-400-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-500-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-600-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-700-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-800-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-900-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1000-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1100-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1200-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1300-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1400-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1500-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1600-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1700-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1800-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-fo-nel-1900-points0.csv';

% i=i+1; numeric_filename{i}='mach-3-nel-50-points0.csv';
% % i=i+1; numeric_filename{i}='mach-3-nel-60-points0.csv';
% % i=i+1; numeric_filename{i}='mach-3-nel-70-points0.csv';
% % i=i+1; numeric_filename{i}='mach-3-nel-80-points0.csv';
% % i=i+1; numeric_filename{i}='mach-3-nel-90-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-100-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-110-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-120-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-130-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-140-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-150-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-160-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-170-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-180-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-190-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-200-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-210-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-220-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-230-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-240-points0.csv';
...
i=i+1; numeric_filename{i}='mach-3-nel-500-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-550-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-1000-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-1200-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-1500-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-1700-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-2000-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-2200-points0.csv';
i=i+1; numeric_filename{i}='mach-3-nel-2500-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-200-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-300-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-400-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-500-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-600-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-700-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-800-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-900-points0.csv';
% i=i+1; numeric_filename{i}='dt-1e-4/mach-3-nel-1000-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1100-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1200-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1300-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1400-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1500-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1600-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1700-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1800-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-1900-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-2000-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-nel-2100-points0.csv';
...
i=i+1; exact_filename_min{i}='data_Density.dat';

% options to minimize the total energy
% % % % options_min.nquad = 5;
% % % % options_min.interpolation_type = 'spline'; % interpolation type
% % % % options_min.index = [11;6;1]; % [11;5;1;2;8]; %[11;6]; % [11;5;1;2;8]; %(x,rho,eps,mach,mat_temp)
% % % % options_min.eos = [5/3;0.14472799784454;1.372e-2;1e-4]; % [\gamma, C_v, a, P_{\infty}]
% % % % options_min.output = false;
% % % % i=0;
% % % % i=i+1; exact_filename_min{i}='data_x.dat';
% % % % i=i+1; exact_filename_min{i}='data_Density.dat';
% % % % i=i+1; exact_filename_min{i}='data_RED.dat';
% % % % i=i+1; exact_filename_min{i}='data_Mach.dat';
% % % % i=i+1; exact_filename_min{i}='data_Temp.dat';
...
for ifile=1:length(numeric_filename)
    ...
    fprintf('----------------------------------------------------------- \n');
    optimset_fminsearch = optimset('TolX',1e-20,'TolFun',1e-20,'Display','off');  
...
for i_var=1:nb_var
    ...
    legend('L_1 norm', 'slope one', 'L_2 norm', 'slope 1/2','Location','best')
