...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
i=0;
% i=i+1; numeric_filename{i}='mach-3-temp-xs-nel-10-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-temp-xs-nel-20-points0.csv';
% i=i+1; numeric_filename{i}='mach-3-temp-xs-nel-40-points0.csv';
i=i+1; numeric_filename{i}='mach-3-temp-xs-nel-80-points0.csv';
i=i+1; numeric_filename{i}='mach-3-temp-xs-nel-160-points0.csv';
i=i+1; numeric_filename{i}='mach-3-temp-xs-nel-320-points0.csv';
i=i+1; numeric_filename{i}='mach-3-temp-xs-nel-640-points0.csv';
...
% % % % options_min.nquad = 5;
% % % % options_min.interpolation_type = 'spline'; % interpolation type
% % % % options_min.index = [11;5;1;2;8]; %[11;6]; % [11;5;1;2;8]; %(x,rho,eps,mach,mat_temp)
...
for i_var=1:nb_var
    ...
    legend('L_1 norm', 'slope one', 'L_2 norm', 'slope 1/2')
