...
\begin{beamercolorbox}[wd=.25\paperwidth,ht=3.25ex,dp=1ex,center]{section in head/foot}%
	\usebeamerfont{section in head/foot} Class Seminar, TAMU-2017 % \insertshorttitle
\end{beamercolorbox}%
...
\urldef{\delchini}\url{delchinimg@ornl.gov}
\urldef{\ferguson}\url{jmferguson@lanl.gov}
\urldef{\morel}\url{morel@tamu.edu}

\title{Viscous regularization of the full set of non-equilibrium-diffusion Grey Radiation-Hydrodynamic equations}

\author{Marc O. Delchini, \underline{Jean C. Ragusa}, Jim Ferguson, Jim E. Morel}
...
\begin{frame}
\titlepage
\small{emails:  {\delchini}, {\ragusa}, {\ferguson}, {\morel} }
...
\end{multline}
where the terms in \tcr{red} are unconditionally entropy-producing (\tcb{Delchini/Ragusa/Ferguson, IJNMF (2017)})
\end{block}
%
\vspace{-2mm}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Semi-analytical solutions}

\begin{block}{Structure of the radiative shock (ideal gas case)}
Is fully described by  
\begin{enumerate}
\item the upstream equilibrium initial Mach number, ${\cal M}_0$,
\item the upstream equilibrium temperature, $T_{\infty}$.
\end{enumerate}
The semi-analytic radiative shock solutions computed by J. Ferguson, following the method described in 
Lowrie/Rauenzahn (2007) and Lowrie/Edwards(2008).\\
%An inherent feature of these equations is their invariance under spatial shifts.
\end{block}

\begin{block}{Solution shifting}
The semi-analytical solution is invariant under spatial shifts and
can be shifted to overlap with the numerical solution.\\
Use conservation of 
\begin{enumerate}
\item mass, or,
\item total energy $\rho E + \varepsilon$
\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Shifting example}

% path to figures directory
\newcommand{\FiguresDirnew}{../paper/latex-files-upload-revision-2}

\begin{figure}[h]
\centering
\includegraphics[width=0.49\textwidth]{\FiguresDirnew/mach-1p05-density-nel-50-zero-shift.pdf}
\includegraphics[width=0.49\textwidth]{\FiguresDirnew/mach-1p05-density-nel-50-plot.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Convergence rate, Mach 1.05, constant opacities}

% path to figures directory
%\renewcommand{\FiguresDirnew}{../paper/latex-files-upload-revision-2/figures-PDF-only/cst-xs/mach-1p05}
\newcommand{\FiguresDirnew}{../paper/latex-files-upload-revision-2}
\vspace{-4mm}
\begin{figure}[h]
\subfigure[Material temperature]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-1p05-mass-energy-diff-mat-temp-convergence.pdf}
}
\subfigure[Material density]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-1p05-mass-energy-diff-density-convergence.pdf}
}
\subfigure[Mach number]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-1p05-mass-energy-diff-mach-number-convergence.pdf}
}
\subfigure[Radiation energy]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-1p05-mass-energy-diff-radiation-convergence.pdf}
}   
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Convergence rate, Mach 3, constant opacities}
...
\begin{figure}[h]
\subfigure[Material temperature]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-3-mass-energy-diff-scd-method-density-convergence.pdf}
}
\subfigure[Material density]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-3-mass-energy-diff-scd-method-mat-temp-convergence.pdf}
}
\subfigure[Mach number]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-3-mass-energy-diff-scd-method-mach-number-convergence.pdf}
}
\subfigure[Radiation energy]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/mach-3-mass-energy-diff-scd-method-radiation-convergence.pdf}
}   
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Convergence rate, Mach 3, $T$- and $\rho$-dependent opacities}
...
\begin{figure}[h]
\subfigure[Material temperature]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/dpt-mass-energy-diff-scd-method-density-convergence.pdf}
}
\subfigure[Material density]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/dpt-mass-energy-diff-scd-method-mat-temp-convergence.pdf}
}
\subfigure[Mach number]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/dpt-mass-energy-diff-scd-method-mach-number-convergence.pdf}
}
\subfigure[Radiation energy]{
\includegraphics[width=0.4\textwidth]{\FiguresDirnew/dpt-mass-energy-diff-scd-method-radiation-convergence.pdf}
}   
\end{figure}
