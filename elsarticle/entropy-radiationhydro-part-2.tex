...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tcr{in this paper, we should give a sweet and short intro to the entr visc results of part 1, a bit like in the MC paper where the theory was reviewed in a few pages, except here we review the final results where the relaxation terms were accounted for. this should be introduced somewhat int he intro section and detailed in a section \# 2\\}

\tcr{the intro should recall some approaches to stabilization for GRH, entr visc, and because it is mostly about numerics, a section of the intro should be devoted to how the GRH have been discretized and solved for by others}
