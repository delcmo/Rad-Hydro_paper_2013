...
\end{equation}
%
The constant $\beta$ is now fully determined and can be used for two purposes: (i) recast the radiation contribution to the definition of the speed of sound given in \eqt{eq:equation5} under the form of a partial derivative alike the definition of the speed of sound for the pure Euler equations, and (ii) get a final expression for the entropy relation given in \eqt{eq:ent_relation}. We start with (i), and using the definition of the radiation entropy, $s_{rad} $ \tcr{where is this actually defined?} \tcb{after equation 8b} , it can be shown that:
%
