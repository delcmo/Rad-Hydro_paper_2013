...
\tcr{signs are opposite of Eq.46?} \tcb{Eq 46 is correct}
 \begin{equation}
 \label{eq:A_matrix}
 \left\{
 \begin{array}{lll}
...
\tcr{where is the concavity of $\tilde{s}_{rad}$ assumed. I know it was mentioned for Euler's entropy. But where did we make the similar assumption for radiation. Ici, ca tombe un peu comme un cheveu sur la soupe} \tcb{concavity of $\tilde{s}_{rad}$ comes from $A_3 \geq 0$ and $A_2 \leq 0$}
