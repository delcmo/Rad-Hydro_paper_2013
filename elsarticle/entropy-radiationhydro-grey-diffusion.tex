...
The approach followed in this paper is similar to those of \cite{Balsara, LowrieMorel}: the relaxation and diffusion terms in the radiation and material energy equations are omitted in order to make \eqt{eq:GRH} hyperbolic \tcb{I do not understand what is wrong with that}. 
