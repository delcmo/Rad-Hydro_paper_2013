...
%
\tcr{Morel circled P'. I do not see anything wrong, do you?}
\begin{equation}
\label{eq:norm_param}
\begin{array}{llll}
...
\tcr{Hereafter, we omit the superscript $'$ for the non-dimensional variables.}
...
%
\tcr{$u_\infty$ was removed below and a $^3$ added}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tcr{ I need to re-write them to better summarize the additions we wrote}
