...
$s_{rad}(\rho,\epsilon)$ is concave with respect to the radiation energy density $\epsilon$. Its functional form of is derived later, in \sect{sect:equ-diff}; \tcr{I believe this is the wrong section, the next one maybe?} $\beta$ is a constant. 
